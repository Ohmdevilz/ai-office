...
def run_trader_task(task_description: str, expected_output: str = "รายงานวิเคราะห์พร้อมแผนการเทรดที่ชัดเจน") -> str:
    ...
    # เพิ่ม KB context เข้าไปใน task description
    enriched_task = (
        f"{kb_context}\n{task_description}"
        if kb_context
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "ก่อนตอบทุกครั้ง คุณจะอ้างอิง Knowledge Base ที่ให้มาใน KNOWLEDGE BASE REFERENCE "
            "เพื่อให้การวิเคราะห์ถูกต้องและสอดคล้องกับหลักการที่กำหนดไว้ "
